...
class System {
    ...
    public:
        ...
        System(const std::vector<double>& params, 
        ...
        void set_state(const std::vector<double>& current_state);
        void set_time(const double& current_time);
        virtual ~System() = default; // define virtual destructor
        virtual void f(std::vector<double> y, double t, std::vector<double> dydt) = 0;
};
#endif